...
### TTS Playback (Client)
- What: Queue-based audio playback with stop/clear controls for spoken replies, plus sentence-level tracking so the active sentence can be highlighted during playback.
